...
public class Flower {
    ...
    protected boolean wildOnly = false;
    ...
    public boolean isWildOnly() {
        return wildOnly;
    }

    public void setWildOnly(boolean wildOnly) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, soilType, origin, visualDescription, growingTip, multiplyingType);
    }
